                ...
                <div className="flex flex-col md:flex-row items-center md:space-x-12">
                    ...
                    <div className="flex-1">
                        <p className="text-lg mb-8">
                            ...
                            With a B.S. in Psychology, I enjoy incorporating principles of human behavior and design to create engaging digital experiences. 
                            I love finding ways to blend science and technology to build intuitive and impactful web applications.
                        </p>
